...
# Hash of the upstream function this module copies. Measured 2026-07-25 against
# Odoo 19.0 (odoo/addons/mail/wizard/mail_compose_message.py:510-543) on a live
# fiqas build. The previous value (4e49f0d6c53f41ac24b02176e97b600a) predates
# Odoo 19 and made this canary fail; our override is re-derived from the source
# below, so bump this together with the override — never one without the other.
VALID_HASHES = {
